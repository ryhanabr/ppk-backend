...
<head>
    ...
    <!-- My Style -->
    <link rel="stylesheet" href="tabel_aktif.css">
</head>
<body>
    <nav class="navigasi navbar navbar-expand-lg bg-light">
      ...
      <div class="container">
        <h1>Layanan Konsultasi Kesehatan</h1><br>
        <table class="table table-hover">
              ...
              .then((json)=> {
                ...
                for (let i = 0; i < data1.length; i++) {
                  if(data1[i].username === "user1" && new Date(data1[i].tanggal) >= new Date()) {
                    ...
                    li += '<td><a href="kesehatan_update.php?id='+data1[i].id+'"><img src="https://cdn.pixabay.com/photo/2017/06/06/00/33/edit-icon-2375785_1280.png" alt="Edit" height="20" width="20"></a>'
                    li += "</tr>";
                    n++;
                  }
          ...
          <h1>Layanan Perawatan Kecantikan</h1><br>
          <table class="table table-hover">
              <thead class="thead-dark">
                <tr>
        ...
        .then((json)=> {
          ...
          for (let i = 0; i < data1.length; i++) {
            if(data1[i].username === "user1" && new Date(data1[i].tanggal) >= new Date()) {
              ...
              lu += '<td><a href="kecantikan_update.php?id='+data1[i].id+'"><img src="https://cdn.pixabay.com/photo/2017/06/06/00/33/edit-icon-2375785_1280.png" alt="Edit" height="20" width="20"></a>'
              lu += "</tr>";
              n++;
            }
