    ...
    <section class="login h-100" style="margin: 30px 0;">
        <div class="login-left w-50 h-100 m-auto">
            <div class="row justify-content-center align-items-center h-100 bg-light">
                <div class="col-10">
                    <div class="header">
                        <h1>Update Data Konsultasi Kesehatan</h1>
                    ...
                    <div class="login-form">
                        ...
                        <form name="inputkesehatan" method="post" id="data">
                            ...
                            <div class="text-center mb-4">
                                <span class="d-inline">Selesai update konsultasi? <a href="kelola_kesehatan.html" class="d-inline text-decoration-none">Kembali</a></span>
                            </div>
                        </form>
                        ...
                        fetch("http://localhost:8080/kesehatan/"+id)
                        ...
                        .then((json)=> {
                            ...
                            form1.keluhan.value = data1.keluhan;
                        });
                        ...
                        <script>
                            ...
                            form.addEventListener('submit', function(e) {
                                let url = "http://localhost:8080/kesehatan/"+id;
                                let update = {
